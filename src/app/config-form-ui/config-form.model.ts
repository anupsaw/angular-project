...
export class ConfigFrom {
    ...
    public type = SzFormControl.input('type', { label: 'Input Type', hint: 'only applied for input control' });
    public hint = SzFormControl.input('hint', { label: 'Hint' });
    ...
    public disable = SzFormControl.input('disable', { label: 'Disable', hint: 'control will be disabled on initial load.' });
    public required = SzFormControl.input('required', { label: 'Required', hint: 'is this control mandatory.' });
